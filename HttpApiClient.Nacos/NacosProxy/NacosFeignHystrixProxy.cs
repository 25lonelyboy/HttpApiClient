...
{
    public class NacosFeignHystrixProxy<T> : AbstactHystrixFeignProxy<T>
    {
        ...
        protected ILogger _logger => ProxyConfiguration.ServiceProvider.GetRequiredService<ILogger<NacosFeignHystrixProxy<T>>>();
